...
LIBS=-lFrescoCustom -lFrescoFoundation -lPocoFoundation -lPocoXML -lPocoNet -lgdal -lTEM
EXEC=aiem
SRC=/home/apbennett/alfresco/src/StatArray.cpp /home/apbennett/alfresco/src/StatFile.cpp aiem.cpp main.cpp
all:
